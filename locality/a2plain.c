 ...
 *
 * Implementation of A2Methods that uses the UArray2 interface. Uses the UArray2
 * array to store the data and all of the UArray2 functions for creating a new
 * array, retrieving array information and mapping.
 */
#include <stdlib.h>
#include <stdio.h>
